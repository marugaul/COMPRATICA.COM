...
$logFile = $logDir . '/emprendedores_debug.log';
...
logDebug("EMPRENDEDORES_START", ['uri' => $_SERVER['REQUEST_URI']]);
...
<head>
  ...
  <title>Emprendedores — <?php echo APP_NAME; ?></title>
  ...
  <style>
    :root {
      ...
      /* Paleta Emprendedores */
      --primary-orange: #ff6b35;
      --primary-orange-light: #ff8a5b;
      --primary-orange-dark: #e5501f;
...
<header class="header">
  <a href="index.php" class="logo">
    ...
    <div class="text">
      ...
      <span class="sub">Emprendedores Ticos</span>
    </div>
  </a>
...
<div class="main-wrapper">
  ...
  <section class="hero-section">
    <div class="hero-content">
      <div class="hero-badge">
        <i class="fas fa-rocket"></i>
        <span>Innovación costarricense</span>
      </div>
      
      <h1 class="hero-title">
        Descubrí proyectos <span class="highlight">hechos con pasión tica</span>
      </h1>
      
      <p class="hero-description">
        Apoyá a emprendedores costarricenses que están innovando y creando productos únicos.
        Desde tecnología hasta artesanías, encontrá lo mejor del talento local en un solo lugar.
      </p>
  ...
  <div class="stats-box">
    <div class="stats-content">
      <div class="stats-header">
        <h2 class="stats-title">El ecosistema emprendedor crece</h2>
        <p class="stats-subtitle">Conocé los números que respaldan el talento tico</p>
      </div>

      <div class="stats-grid">
        <div class="stat-item">
          <span class="stat-number">150+</span>
          <span class="stat-label">Emprendimientos registrados</span>
        </div>
        <div class="stat-item">
  ...
  <div class="section-header">
    ...
    <p class="section-subtitle">
      Explorá diferentes industrias donde los emprendedores ticos están marcando la diferencia
    </p>
  </div>
  ...
  <div class="categories-grid">
    <article class="category-card">
      ...
      <h3 class="category-title">Tecnología & Software</h3>
      <p class="category-description">
        Apps, SaaS, herramientas digitales y soluciones tecnológicas desarrolladas por talento local.
      </p>
    ...
    <article class="category-card">
      ...
      <h3 class="category-title">Moda & Accesorios</h3>
      <p class="category-description">
        Ropa, calzado, accesorios y joyería con diseños únicos creados por diseñadores costarricenses.
      </p>
      <div class="category-footer">
        <span class="category-badge">
          <span class="dot"></span>
    ...
    <article class="category-card">
      ...
      <h3 class="category-title">Alimentos & Bebidas</h3>
      <p class="category-description">
        Productos gourmet, snacks artesanales, café de especialidad y delicias hechas en Costa Rica.
      </p>
      <div class="category-footer">
        <span class="category-badge">
          <span class="dot"></span>
    ...
    <article class="category-card">
      ...
      <p class="category-description">
        Productos ecológicos, reutilizables y sostenibles que cuidan el planeta y apoyan lo local.
      </p>
      <div class="category-footer">
        <span class="category-badge">
          <span class="dot"></span>
    ...
    <article class="category-card">
      ...
      <h3 class="category-title">Hogar & Decoración</h3>
      <p class="category-description">
        Muebles, arte, decoración y productos para el hogar con estilo y sello costarricense.
      </p>
      <div class="category-footer">
        <span class="category-badge">
          <span class="dot"></span>
    ...
    <article class="category-card">
      ...
      <h3 class="category-title">Belleza & Cuidado Personal</h3>
      <p class="category-description">
        Cosméticos naturales, productos de skincare y cuidado personal fabricados en Costa Rica.
      </p>
      <div class="category-footer">
        <span class="category-badge">
          <span class="dot"></span>
  ...
  <div class="cta-box">
    ...
    <h2 class="cta-title">¿Tenés un emprendimiento?</h2>
    <p class="cta-text">
      Registrá tu proyecto en CompraTica y conectá con miles de clientes potenciales en todo el país.
      Es gratis y te tomará solo unos minutos configurar tu tienda.
    </p>
...
// Botones de acción
document.querySelectorAll('.stats-btn, .cta-button').forEach(btn => {
