<?php
// admin/servicios_config.php
// Configuración de planes de SERVICIOS
    ...
    if ($action === 'delete_plan') {
        ...
        if ($id > 0) {
            try {
                ...
                $stmt = $pdo->prepare("SELECT COUNT(*) as count FROM job_listings WHERE listing_type='service' AND pricing_plan_id = ?");
                $stmt->execute([$id]);
...
<title>Configuración de Planes - Servicios</title>
...
<div class="header">
  <div class="logo">
    ...
    Configuración de Planes - Servicios
  </div>
  <div class="nav-buttons">
    ...
    <a class="nav-btn" href="../services/dashboard.php">
