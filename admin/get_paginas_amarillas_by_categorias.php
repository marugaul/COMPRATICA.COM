<?php
/**
 * API para obtener lugares de Páginas Amarillas por categorías
...
try {
    ...
    if (!$check) {
        echo json_encode(['success' => false, 'error' => 'Tabla lugares_paginas_amarillas no existe']);
        exit;
    }
    ...
    $sql = "SELECT id, nombre, categoria, telefono, email, ciudad
