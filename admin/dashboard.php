...
<header class="header" style="background: linear-gradient(135deg, #2c3e50 0%, #34495e 100%); box-shadow: 0 2px 12px rgba(0,0,0,0.1); padding: 1rem 2rem;">
  ...
  <nav style="display: flex; gap: 0.5rem; flex-wrap: wrap; align-items: center;">
    ...
    <a class="nav-btn" href="clientes.php" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.625rem 1rem; background: rgba(255,255,255,0.1); color: white; text-decoration: none; border-radius: 6px; font-size: 0.875rem; font-weight: 500; transition: all 0.3s ease; border: 1px solid rgba(255,255,255,0.2);" onmouseover="this.style.background='rgba(255,255,255,0.2)'; this.style.borderColor='rgba(255,255,255,0.4)';" onmouseout="this.style.background='rgba(255,255,255,0.1)'; this.style.borderColor='rgba(255,255,255,0.2)';">
    ...
    <a class="nav-btn" href="swiftpay.php" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.625rem 1rem; background: rgba(13,27,62,0.7); color: white; text-decoration: none; border-radius: 6px; font-size: 0.875rem; font-weight: 500; transition: all 0.3s ease; border: 1px solid rgba(59,155,255,0.5);" onmouseover="this.style.background='rgba(13,27,62,1)'; this.style.borderColor='rgba(59,155,255,0.9)';" onmouseout="this.style.background='rgba(13,27,62,0.7)'; this.style.borderColor='rgba(59,155,255,0.5)';">
