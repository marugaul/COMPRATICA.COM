...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: 'Inter', sans-serif; background: linear-gradient(135deg, #7b3f00, #c06a1a); min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 2rem; gap: 1.25rem; }
    ...
    .btn-primary { background: #7b3f00; color: #fff; margin-bottom: 0.75rem; display: block; }
    .btn-primary:hover { background: #5c2f00; }
    .btn-secondary { background: #fdf3e7; color: #7b3f00; display: block; }
    .btn-secondary:hover { background: #f5dfc0; }
  </style>
</head>
<body>
  <nav class="topnav">
    <a href="/">🏠 CompraTica</a>
    <a href="/bienes-raices">🏠 Ver Bienes Raíces</a>
    <a href="/servicios">🔧 Ver Servicios</a>
  </nav>
  <div class="card">
    <div class="icon">👋</div>
    <h1>Sesión cerrada</h1>
    <p>Tu sesión en el Portal de Bienes Raíces ha sido cerrada correctamente.</p>
    <a href="/" class="btn btn-primary">🏠 Ir a la página principal</a>
    <a href="/real-estate/login.php" class="btn btn-secondary">Volver a iniciar sesión</a>
  </div>
</body>
</html>
