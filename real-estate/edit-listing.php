...
<body>
      ...
      <div class="form-card">
        <div class="form-section">
          ...
          <div class="map-picker-wrap">
            ...
            <input type="hidden" name="latitude"  id="input-latitude"  value="<?= htmlspecialchars($listing['latitude'] ?? '') ?>">
            <input type="hidden" name="longitude" id="input-longitude" value="<?= htmlspecialchars($listing['longitude'] ?? '') ?>">
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    var initLng  = <?= !empty($listing['longitude']) ? (float)$listing['longitude'] : 'null' ?>;
