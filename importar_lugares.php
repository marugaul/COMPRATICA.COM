...
// Verificar que sea admin (TEMPORALMENTE DESHABILITADO PARA TESTING)
...
out center;';
        ...
        <div class="mt-4">
            <a href="/admin/email_marketing.php?page=dashboard" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i> Volver al Dashboard
            </a>
            <div class="alert alert-warning mt-3">
                <strong>⚠️ Archivo Temporal:</strong> Esta es una versión pública temporal para testing.
                <br>Ubicación: <code>https://compratica.com/importar_lugares.php</code>
                <br><small>Eliminar después de uso.</small>
            </div>
        </div>
    </div>
    ...
    async function createTable() {
        ...
        try {
            const response = await fetch('importar_lugares.php', {
                method: 'POST',
